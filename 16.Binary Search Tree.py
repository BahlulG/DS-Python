class BST:
    ...
    def insert(self, data):
        ...
        if data > self.key:
            ...
            else:  # If Right Child is None, meaning if Right Child has no Node
                self.RightChild = BST(data)  # Here we initialize the BST Class and create new Right Child with Left and Right Child equals to None
        else:
            if self.LeftChild:
